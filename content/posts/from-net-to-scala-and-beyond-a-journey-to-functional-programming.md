...
Unfortunately for you, the only way forward is realization that what we know as OOP had lived to its maximum potential. There's nothing wrong with OOP per-se, but if you feel you've had [Enough!](http://hmemcpy.com/2017/03/enough/) with ever-growing complexity, fighting tests or IoC containers, or general feeling of solving the same issues over and over, year after year, perhaps its time to consider moving onto something completely different.
